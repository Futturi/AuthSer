...
func (x *CheckIdentityRequest) GetHeader() string {
	if x != nil {
		return x.Header
	}
	return ""
...
func (x *CheckIdentityResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_sso_proto_rawDesc = []byte{
	...
	0x68, 0x22, 0x2e, 0x0a, 0x14, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x22, 0x30, 0x0a, 0x15, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65,
	0x72, 0x49, 0x64, 0x22, 0x43, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52,
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xbd, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39,
	...
	0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x48, 0x0a, 0x0d, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x1a, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x20, 0x5a, 0x1e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x46, 0x75, 0x74, 0x74, 0x75, 0x72, 0x69, 0x2f, 0x41, 0x75, 0x74, 0x68,
...
var file_sso_proto_goTypes = []interface{}{
	(*CheckIdentityRequest)(nil),  // 0: auth.CheckIdentityRequest
	(*CheckIdentityResponse)(nil), // 1: auth.CheckIdentityResponse
...
var file_sso_proto_depIdxs = []int32{
	...
	0, // 2: auth.Auth.CheckIdentity:input_type -> auth.CheckIdentityRequest
	3, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	5, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	1, // 5: auth.Auth.CheckIdentity:output_type -> auth.CheckIdentityResponse
...
func file_sso_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sso_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckIdentityRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sso_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckIdentityResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
